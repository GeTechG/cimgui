...
//based on imgui.h file version "1.90.2 WIP" 19011 from Dear ImGui https://github.com/ocornut/imgui
...
typedef struct ImGuiLayoutItem ImGuiLayoutItem;
...
typedef struct ImVector_ImGuiLayoutItem {int Size;int Capacity;ImGuiLayoutItem* Data;} ImVector_ImGuiLayoutItem;
...
typedef struct ImVector_ImGuiLayoutPtr {int Size;int Capacity;ImGuiLayout** Data;} ImVector_ImGuiLayoutPtr;
...
typedef ImVector<ImGuiLayout*> ImVector_ImGuiLayoutPtr;
typedef ImVector<ImGuiLayoutItem> ImVector_ImGuiLayoutItem;
...
CIMGUI_API ImGuiLayoutItem* ImGuiLayoutItem_ImGuiLayoutItem(ImGuiLayoutItemType type);
CIMGUI_API void ImGuiLayoutItem_destroy(ImGuiLayoutItem* self);
CIMGUI_API ImGuiLayout* ImGuiLayout_ImGuiLayout(ImGuiID id,ImGuiLayoutType type);
CIMGUI_API void ImGuiLayout_destroy(ImGuiLayout* self);
